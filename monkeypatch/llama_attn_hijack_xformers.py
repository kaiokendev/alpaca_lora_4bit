...
def xformers_forward(
    ...
    if not output_attentions:
        ...
        query_states = query_states.transpose(1, 2).to(dtype=dtype)
        key_states = key_states.transpose(1, 2).to(dtype=dtype)
        value_states = value_states.transpose(1, 2).to(dtype=dtype)
